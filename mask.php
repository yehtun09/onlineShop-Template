                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 border-dark border-md-end">
                                                <div class="d-flex justify-content-center">
                                                    <div class="">
                                                        <img src="img/mask1.png" class="img-fluid w-100" alt="...">
                                                    </div>
                        ...
                        <p>Quantity: <span class="mx-4">2</span></p>
                                            ...
                                            <div class="col-md-7">
                                                <h4 class="title fs-4 fw-bolder pb-3">REVS Bio Gel Mask</h4>
                                                            ...
                                                            <table class="table">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>Carrageenan, Glucomannan, etc.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-nowrap">
                                                                        Volume  
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-5 border-dark border-md-end">
                                                <div class="d-flex justify-content-center">
                                                    <div class="">
                                                        <img src="img/mask2.png" class="img-fluid w-100" alt="...">
                                                    </div>
                                                    <!-- <div class="flex-grow-1 ms-3">
                        <h5 class="title fs-6 fw-bolder">Printed Hawaii Shirt Brutus</h5>
                        <h6 class="title fs-6 fw-bolder mb-2">Ks. 12600</h6>
                        ...
                        <p>Quantity: <span class="mx-4">2</span></p>
                                            ...
                                            <div class="col-md-7">
                                                <h4 class="title fs-4 fw-bolder pb-3">REVS Sparkling Mask</h4>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="title fs-6 fw-bolder mb-2">
                                                        </h5>
                                                            ...
                                                            <table class="table">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>Polynucleotides (PN), Carbonated Water etc.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-nowrap">
                                                                        Volume  
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        Skin whitening improvement <br> Skin wrinkle improvement
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
        ...
        <div class="row">
            <div class="col-md-4 col-12">
                ...
                <div class="position-relative hovereffect">
                    <img src="img/mask1.png" alt="" class="w-100 mb-3">
              ...
              <a href="#" class="btn btn-dark text-uppercase btn-sm">Out of stock</a> -->
                ...
                <h4 class="fs-6 title">REVS Bio Gel Mask</h4>
                <h5></h5>
            </div>
            <div class="col-md-4 col-12">

                <div class="position-relative hovereffect">
                    <img src="img/mask2.png" alt="" class="w-100 mb-3">
                    <div class="position-absolute top-0 m-3">
                        <!-- <a href="#" class="btn btn-info btn-sm text-white text-uppercase">Sales</a>
              <a href="#" class="btn btn-dark text-uppercase btn-sm">Out of stock</a> -->
                    </div>
                ...
                <!-- <p class="text-muted">Aesthetics Products</p> -->
                <h4 class="fs-6 title">REVS Sparkling Mask</h4>
                <h5></h5>
            </div>
