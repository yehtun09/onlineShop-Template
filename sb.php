                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 border-dark border-md-end">
                                                <div class="d-flex justify-content-center">
                                                    <div class="">
                                                        <img src="img/skinboost1.png" class="img-fluid w-100"
                                                            alt="...">
                                                    </div>
                        ...
                        <p>Quantity: <span class="mx-4">2</span></p>
                                            ...
                                            <div class="col-md-7">
                                                <h4 class="title fs-4 fw-bolder pb-3">REVS Booster Serum</h4>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="title fs-6 fw-bolder mb-2">
                                                        </h5>
                                                        <!-- <h6 class="title fs-6 fw-bolder mb-2">Ks. 12600</h6> -->
                                                            ...
                                                            <table class="table">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>Oligopeptide, Polynucleotide (PN), Hyaluronic Acid (HA), etc.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-nowrap">
                                                                        Composition
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        Store at room temperature 1-30°C and avoid direct sunlight and humidity
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-5 border-dark border-md-end">
                                                <div class="d-flex justify-content-center">
                                                    <div class="">
                                                        <img src="img/skinboost2.png" class="img-fluid w-100"
                                                            alt="...">
                                                    </div>
                                                    <!-- <div class="flex-grow-1 ms-3">
                        <h5 class="title fs-6 fw-bolder">Printed Hawaii Shirt Brutus</h5>
                        ...
                        <p>Quantity: <span class="mx-4">2</span></p>
                                            ...
                                            <div class="col-md-7">
                                                <h4 class="title fs-4 fw-bolder pb-3">REVS Pro32</h4>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="title fs-6 fw-bolder mb-2">
                                                        </h5>
                                                            ...
                                                            <table class="table">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>Low + High molecular weight Hyaluronic Acid (HA), etc.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-nowrap">
                                                                        Composition
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-5 border-dark border-md-end">
                                                <div class="d-flex justify-content-center">
                                                    <div class="">
                                                        <img src="img/skinboost3.png" class="img-fluid w-100"
                                                            alt="...">
                                                    </div>
                                                    <!-- <div class="flex-grow-1 ms-3">
                        <h5 class="title fs-6 fw-bolder">Printed Hawaii Shirt Brutus</h5>
                        ...
                        <p>Quantity: <span class="mx-4">2</span></p>
                                            ...
                                            <div class="col-md-7">
                                                <h4 class="title fs-4 fw-bolder pb-3">REVS RMT140HPn</h4>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="title fs-6 fw-bolder mb-2">
                                                        </h5>
                                                            ...
                                                            <table class="table">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>Polynucleotide (PN), Hyaluronic Acid (HA), etc.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-nowrap">
                                                                        Composition
            ...
            <div class="container py-2">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="text-center fs-6"><i class="bi bi-house-door px-1"></i>Home >> Products >> Aesthetics
                            Products >> Skin Booster</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-12">
                ...
                <div class="position-relative hovereffect">
                    <img src="img/skinboost1.png" alt="" class="w-100 mb-3">
              ...
              <a href="#" class="btn btn-dark text-uppercase btn-sm">Out of stock</a> -->
                ...
                <!-- <p class="text-muted">Aesthetics Products</p> -->
                <h4 class="fs-6 title">REVS Booster Serum</h4>
                <h5 class="fs-6"></h5>
            </div>
            ...
            <div class="col-md-4 col-12">
                ...
                <div class="position-relative hovereffect">
                    <img src="img/skinboost2.png" alt="" class="w-100 mb-3">
                    <div class="position-absolute top-0 m-3">
                        <!-- <a href="#" class="btn btn-info btn-sm text-white text-uppercase">Sales</a>
              <a href="#" class="btn btn-dark text-uppercase btn-sm">Out of stock</a> -->
                    </div>
                    <div class="overlay">
                        <div class="row ">
                            <div class="col-md-2 ">
                                <a class="info p-2" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal-2"><i
                                        class="bi bi-search"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <!-- <p class="text-muted">Aesthetics Products</p> -->
                <h4 class="fs-6 title">REVS PRO 32</h4>
                <h5 class="fs-6">2 ml</h5>
            </div>

            <div class="col-md-4 col-12">

                <div class="position-relative hovereffect">
                    <img src="img/skinboost3.png" alt="" class="w-100 mb-3">
                    <div class="position-absolute top-0 m-3">
                        <!-- <a href="#" class="btn btn-info btn-sm text-white text-uppercase">Sales</a>
              <a href="#" class="btn btn-dark text-uppercase btn-sm">Out of stock</a> -->
                    </div>
                    <div class="overlay">
                        <div class="row ">
                            <div class="col-md-2 ">
                                <a class="info p-2" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal-3"><i
                                        class="bi bi-search"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <!-- <p class="text-muted">Aesthetics Products</p> -->
                <h4 class="fs-6 title">REVS RMT 140 HPN</h4>
                <h5 class="fs-6"></h5>
            </div>
