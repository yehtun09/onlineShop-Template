                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 border-dark border-md-end">
                                                <div class="d-flex justify-content-center">
                                                    <div class="">
                                                        <img src="img/revs1.png" class="img-fluid w-100"
                                                            alt="...">
                                                    </div>
                        ...
                        <p>Quantity: <span class="mx-4">2</span></p>
                                            ...
                                            <div class="col-md-7">
                                                <h4 class="title fs-4 fw-bolder pb-3">REVS Repairing Serum</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="text-center fs-6"><i class="bi bi-house-door px-1"></i>Home >> Products >> Aesthetics
                            Products >> REVS Repairing Serum 30 ml</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-12">
                ...
                <div class="position-relative hovereffect">
                    <img src="img/revs1.png" alt="" class="w-100 mb-3">
              ...
              <a href="#" class="btn btn-dark text-uppercase btn-sm">Out of stock</a> -->
                ...
                <h4 class="fs-6 title">REVS Repairing Serum</h4>
                <h5></h5>
            </div>
